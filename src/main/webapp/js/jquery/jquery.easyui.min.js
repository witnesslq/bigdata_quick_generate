...
},beforePageText:"页",afterPageText:"of {pages}",displayMsg:"显示{from} to {to} of {total} 信息",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"这个字段不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_444,blur:_448,mouseenter:_44c,mouseleave:_44f,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入有效的邮箱地址."},url:{validator:function(_46f){
...
},message:"请输入有效的URL."},length:{validator:function(_470,_471){
var len=$.trim(_470).length;
return len>=_471[0]&&len<=_471[1];
},message:"请输入数据长度在 {0} 和  {1} 之间."},remote:{validator:function(_472,_473){
var data={};
data[_473[1]]=_472;
...
return $(_a0g).datebox("options").cleanText;
},handler:function(_a0h){
$(_a0h).combo('setValue', '').combo('setText', '');  
